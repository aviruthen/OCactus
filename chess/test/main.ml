...
let rec gen_board board move_lst = match move_lst with
| [] -> board
...
let move_test_illegal (name : string) (board_state : board_state) 
(cmd : string) = 
  name >:: fun _ -> 
...
let stalemate_moves = ["e2 e3"; "a7 a5"; "d1 h5"; "a8 a6"; "h5 a5"; "h7 h5"; 
                       "h2 h4"; "a6 h6"; "a5 c7"; "f7 f6"; "c7 d7"; "e8 f7";
                       "d7 b7"; "d8 d3"; "b7 b8"; "d3 h7"; "b8 c8"; "f7 g6";
                       "c8 e6"]
let scholars_mate = ["e2 e4"; "a7 a6"; "f1 c4"; "a6 a5"; "d1 h5"; "a5 a4";
                     "h5 f7"]
let sym_mate = ["e2 e4"; "e7 e5"; "g1 f3"; "g8 f6"; "b1 c3"; "b8 c6";
                "f1 b5"; "f8 b4"; "e1 g1"; "e8 g8"; "d2 d3"; "d7 d6";
                "b5 c6"; "b4 c3"; "c6 b7"; "c3 b2"; "b7 a8"; "b2 a1";
                "c1 g5"; "c8 g4"; "d1 a1"; "d8 a8"; "g5 f6"; "g4 f3";
                "f6 e5"; "f3 e4"; "e5 g7"; "e4 g2"; "g7 f8"; "g2 f1"; 
                "a1 g7"]
let draw_by_50 = ["e2 e4"; "e7 e5"; "e1 e2"; "e8 e7"; "e2 e1"; "e7 e8";
                   "e1 e2"; "e8 e7"; "e2 e1"; "e7 e8"; "e1 e2"; "e8 e7"; 
                   ...
                   "e1 e2"; "e8 e7"; "e2 e1"; "e7 e8"; "e1 e2"; "e8 e7"; 
                   "e2 e1"; "e7 e8"; "e1 e2"; "e8 e7"; "e2 e1"; "e7 e8";]
let disc_check = ["e2 e4"; "d7 d5"; "d1 e2"; "e8 d7"; "h2 h3"; 
                  "d7 e6"; "e4 d5"]
...
let castle_setup = ["e2 e4"; "e7 e5"; "g1 f3"; "g8 f6"; "f1 c4"; "f8 c5";
                    ...
                    "d1 d2"; "d8 d7"]
let castle_setup_check = ["e2 e4"; "d7 d5"; "g1 f3"; "e7 e6"; "f1 d3"; "d8 e7";
                    "e4 d5"; "e6 d5"]
let castle_setup_king_move = ["e2 e4"; "e7 e5"; "g1 f3"; "g8 f6"; "f1 c4";
                    "f8 c5"; "e1 e2"; "e8 e7"; "e2 e1"; "e7 e8"]
let castle_setup_thru_check = ["e2 e3"; "d7 d5"; "g1 f3"; "c8 f5"; "f1 d3";
                    "f5 d3"]
let castle_setup_rook_move = ["e2 e4"; "e7 e5"; "g1 f3"; "g8 f6"; "f1 c4"; 
...
Int64.of_int 4194304; Int64.of_int 8388608; Int64.of_int 16777216; 
Int64.of_int 33554432; Int64.of_int 67108864; Int64.of_int 134217728; 
Int64.of_int 268435456; Int64.of_int 536870912; Int64.of_int 1073741824; 
Int64.of_int 2147483648; ]
let init_knight_moves = [
Int64.of_int 65536; Int64.of_int 262144; Int64.of_int 2097152;
...
let state_tests = [
    ("Stalemate" >:: fun _ -> assert_equal 
    [] (all_legal_moves (pseudolegal_moves stalemate_board)));
    ("Checkmate 4 moves" >:: fun _ -> assert_equal 
    [] (all_legal_moves (pseudolegal_moves schl_mate_board)));
    ("Checkmate Symmetrical Game" >:: fun _ -> assert_equal 
    [] (all_legal_moves (pseudolegal_moves sym_mate_board)));
    ("Draw By Fifty" >:: fun _ -> assert_equal
    101 (get_fifty draw_by_50_board));
    ("Initial Attacking Squares White" >:: fun _ -> assert_equal
    16711680 (Int64.to_int (enemy_attacks init_chess)));
    ("Initial Attacking Squares Black" >:: fun _ -> assert_equal
    280375465082880 (Int64.to_int (enemy_attacks e4_board)));
    (*("Previous Board After One Move" >:: fun _ -> assert_equal
    e4_board (List.hd (get_prev_boards e4_board)));*)
    ("Inital King Moves" >:: fun _ -> assert_equal
    [] (moves_king init_chess true));
    ("Inital Queen Moves" >:: fun _ -> assert_equal
    [] (moves_queen init_chess true));
    ("Inital Rook Moves" >:: fun _ -> assert_equal
    [] (moves_rook init_chess true));
    ("Inital Knight Moves" >:: fun _ -> assert
    (cmp_move_lists init_knight_moves (moves_knight init_chess true)));
    ("Inital Bishop Moves" >:: fun _ -> assert_equal
    [] (moves_bishop init_chess true));
    ("Inital Pawn Moves" >:: fun _ -> assert
    (cmp_move_lists init_pawn_moves 
    ((moves_pawn_single init_chess true) @ (moves_pawn_double init_chess true))));
    ("Inital En Passant Moves" >:: fun _ -> assert
    ([] = moves_ep_captures init_chess true));
    ("No check initially" >:: fun _ -> assert_equal
    false (in_check init_chess));
    ("Discovered Check" >:: fun _ -> assert_equal
    true (in_check disc_check_board));
    ("Discovered Check Not Mate" >:: fun _ -> assert
    ([] <> (all_legal_moves (pseudolegal_moves disc_check_board))));
    ("Moves Still Generated in Check Queen" >:: fun _ -> assert
    ([] <> moves_queen disc_check_board false));
    ("No Valid Moves For Rook Discovered Check" >:: fun _ -> assert
    ([] = moves_rook disc_check_board false));
    ("Moves Still Generated in Check Bishop" >:: fun _ -> assert
    ([] <> moves_bishop disc_check_board false));
    ("Moves Still Generated in Check Knight" >:: fun _ -> assert
    ([] <> moves_knight disc_check_board false));
    ("Moves Still Generated in Check Pawns (Single)" >:: fun _ -> assert
    ([] <> moves_pawn_single disc_check_board false));
    ("Moves Still Generated in Checks Pawns (Double)" >:: fun _ -> assert
    ([] <> moves_pawn_double disc_check_board false));
    ("No Valid Moves For Pawn (EP) Discovered Check" >:: fun _ -> assert
    ([] = moves_ep_captures disc_check_board false));
]
